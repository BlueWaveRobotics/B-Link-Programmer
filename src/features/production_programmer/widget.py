...
#                 top: -4px;
#                 left: 25px; /* تنظیم فاصله عنوان از سمت چپ */
#                 padding: 4px 25px 4px 12px; /* پدینگ عنوان (راست: 25px) */
#                 background-color: transparent;
#                 color: #00E5FF;
#                 font-size: 12px;
#                 font-weight: 700;
...
#             /* حالت اولیه فیلد آدرس فایل (فقط خواندنی) */
#             QLineEdit:read-only {
#                 background-color: #070B19;
#                 color: #94A3B8;
#                 border: 1px solid #1A2642;
#             }
#             /* وقتی فایلی لود بشود، این استایل کادر و متن را آبی می‌کند */
...
#         # ----------------------------------------------------------------------
#         # 2. Production statistics (مشکل نوشته‌های روی هم افتاده در اینجا حل شد)
#         # ----------------------------------------------------------------------
#         stats_box = QGroupBox("Shift Production Statistics", self)
#         stats_layout = QHBoxLayout(stats_box)
#         stats_layout.setContentsMargins(8, 30, 25, 8)
...
#         # مقداردهی و تخصیص مستقیم لیبل‌های آمار به داخل کارت‌ها
...
#         file_layout.setContentsMargins(8, 30, 25, 8)
...
#         probe_layout.setContentsMargins(8, 30, 25, 8)
...
#         prov_layout.setContentsMargins(8, 30, 25, 8)
...
#             # روشن کردن استایل آبی بعد از انتخاب فایل!
...
#             # روشن کردن استایل آبی هنگام لود شدن پروفایل
#             self.txt_file_path.setProperty("hasFile", True)
#             self.txt_file_path.style().unpolish(self.txt_file_path)
#             self.txt_file_path.style().polish(self.txt_file_path)
"""
    ...
    def _apply_styles(self) -> None:
        ...
        self.setStyleSheet(
            ...
            QGroupBox::title {
                ...
                left: 0px; 
                padding-left: 4px;
                padding-right: 20px; /* ایجاد فاصله از سمت راست متن عنوان تا خط کادر */
                padding-top: 2px;
                padding-bottom: 2px;
                background-color: transparent;
                color: #00E5FF;
