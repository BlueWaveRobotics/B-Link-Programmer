...
#         on the specific probe identified by unique_id.
#         """
#         session = None
#         start_time = time.perf_counter()
#         chip_uid = "UNKNOWN-UID"
...
#             options = {
#                 "connect_mode": self.connect_mode,
#                 # Safe speed for mass erase
#                 "frequency": min(self.clock_freq, 1000000),
#                 "reset_type": "hw" if self.connect_mode == "under-reset" else "sw",
...
#             self.progress_signal.emit(self.unique_id, 100)
#             self.status_signal.emit(
#                 self.unique_id, "PASS", "Full Chip Erase completed. Memory is blank.", elapsed_time, chip_uid
#             )
#             self.finished_signal.emit(self.unique_id, True)
...
#         # Do NOT auto-delete thread or worker via deleteLater here!
#         # They will be cleaned up safely in stop_all_workers() to prevent C++ lifecycle crashes.
