...
#     QScrollArea,
#     QFrame,
#     QComboBox,  # ⬅️ اضافه شدن QComboBox
# )
...
#         # =============================================================
#         # 🌟 بخش جدید: اضافه شدن منوی کشویی برای انتخاب نوع رابط
#         # =============================================================
...
#         """Trigger target probe with selected interface."""
#         selected_iface = self.cmb_interface.currentText()  # ⬅️ خواندن مقدار انتخابی
...
#         # ⬅️ ارسال نوع اینترفیس انتخابی به ورکر
...
#         """Trigger core register diagnostics."""
#         selected_iface = self.cmb_interface.currentText()  # ⬅️ خواندن مقدار انتخابی
...
#         """Format and display decoded ARM debug registers."""
#         self.btn_refresh.setEnabled(True)
#         self.btn_inspect.setEnabled(True)
#         self.cmb_interface.setEnabled(True)
