...
#         # Minimum width to prevent the right panel from getting too small
...
#         """
#         Locks/Unlocks the entire diagnostic panel based on the global bottom status bar state.
#         """
#         if connected:
#             # Unlock panel and buttons
...
#                     "\n[INFO] DAPLink probe re-connected. Click 'Refresh Target' to scan MCU.")
#         else:
#             # Lock the right panel completely
#             self.btn_refresh.setEnabled(False)
#             self.btn_inspect.setEnabled(False)
#             self.cmb_interface.setEnabled(False)

#             self.lbl_status.setText("Status: DISCONNECTED / LOCKED")
#             self.lbl_status.setStyleSheet(
#                 "color: #EF4444; font-weight: bold; font-size: 13px;")
...
#             # Show the requested specific English guidance in the terminal
#             self.txt_diag_display.setPlainText(
#                 "=== HARDWARE DISCONNECTED ===\n\n"
#                 "Please verify physical connections to your system.\n"
#                 "To continue:\n"
#                 "1. Check the USB cable connection.\n"
#                 "2. Unplug the USB cable from your system once and re-insert it.\n"
#                 "3. Wait for DAPLink LED to turn green."
#             )
...
#         self._append_diag_log(
#             "\n[CRITICAL ERROR] USB interface stopped responding.")
#         self._append_diag_log(
